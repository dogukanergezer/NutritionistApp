...
namespace Clinic_Management_System
{
    public partial class Visits : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen bir muayene seçiniz!!");
                return;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen alanları doldurunuz girin!");
                return;
            }
            ...
            if (command.ExecuteNonQuery() > 0)
                ...
                MessageBox.Show("Muayene oluşturulumadı!");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen nedenleri ile birlikte teşhisi girin!");
                return;
            }
            ...
            if (command.ExecuteNonQuery() > 0)
                ...
                MessageBox.Show("Muayene güncellenemedi!");
